...
int main()
{
	...
	course1.addStudent("Peter Pan"); //因為上面有copy 所以原本student是Peter Pan
	course2.addStudent("Lisa Ma"); //後來又add Lisa覆蓋上原本的Peter Pan

	cout << "student in circle1: " << course1.getStudent()[0] << endl; //所以印出兩個student的值都是Lisa Ma
